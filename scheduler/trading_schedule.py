# scheduler/trading_schedule.py — Tự động hóa theo giờ giao dịch HOSE
#
# 08:30  Báo cáo mở cửa (sync MBS + phân tích tích hợp)
# 10:00  Cảnh báo giữa phiên sáng
# 11:30  Tổng kết phiên sáng (không gọi LLM, tiết kiệm chi phí)
# 14:00  Cảnh báo đầu phiên chiều
# 15:00  Báo cáo đóng cửa (LLM phân tích toàn ngày)
...
from agent.report_pipeline import fetch_data, run_report_pipeline, sanitize_for_telegram
from agent.market_report_pipeline import run_integrated_pipeline
...
def task_morning_open():
    ...
    # Chạy báo cáo tích hợp (thị trường + danh mục)
...
def run_task_now(task_name: str):
    ...
    tasks = {
        ...
        "close":  task_close,
        "market": lambda: run_integrated_pipeline(),
    }
